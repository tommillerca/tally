...
const APP_BUILD = 'v326'; // shown in Settings so we can confirm the running build; bump with sw.js VERSION. BRANCH catfish-anim: renumber to the next free version at merge time
