...
const APP_BUILD = 'v370'; // RENUMBER AT MERGE (v369 is walt/paddock-entry, unmerged) // shown in Settings so we can confirm the running build; bump with sw.js VERSION
