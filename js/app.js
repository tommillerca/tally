...
const APP_BUILD = 'v323'; // shown in Settings so we can confirm the running build; bump with sw.js VERSION. BRANCH crew-fan: renumber to the next free version at merge time
