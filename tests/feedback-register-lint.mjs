 ...
 *   ROWS      it contains at least one item row, so an empty table cannot pass.
 ...
 *   ROWS      delete the item rows          -> FAIL
...
ok('ROWS the register is not empty', openRows.length > 0, `${openRows.length} open item(s)`);
