 ...
 *          MEASURED, and the measurement killed it. NINE healthy runs on
 *          2026-08-25, across origin/main AND this branch, across v440 AND
 *          v441, machine busy (load 4.5-9.3):
 *              0.58  0.63  0.66  0.69  0.71  0.72  0.77  0.78  0.83
 *          Median 0.71, and RED on five of the nine. r2's recorded score is
 *          0.78 -- inside the band, with two healthy runs scoring WORSE than
 *          the mutation. WARM cannot separate r2 from a healthy app, so
 ...
 *       nine runs include origin/main, where WARM went 0.72 / 0.69 / 0.78 --
 ...
 * healthy band (0.58-0.83, nine runs, 2026-08-25), so WARM cannot tell them
