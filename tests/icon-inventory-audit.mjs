...
const EMITTERS = {
  ...
  'js/app.js:renderSalvageBench':   ['scene', 'the Salvage Bench, lifted out of renderCharacter in v588 when it moved from the Backpack to the Wardrobe. Its dust and bolt chips are icon SITES, listed below.'],
...
const SUBFLOOR = {
  ...
  'js/app.js:footballShelfHtml|coin':     '13px in the kit room\'s price line and 12px on its buy buttons, the same chips as renderShop|coin above and set in the same t3-price and drop-buy rules. Football kit, 2026-09-04.',
  /* 2026-09-05: the kit room's tiles moved into footballDropBodyHtml (rendered lazily on open); same 12px chips, same reason. */
  ...
  'js/app.js:renderSalvageBench|dust':    '13px dust chips in the bench wallet line, lede and melt bar; the same sites renderCharacter carried before v588.',
  ...
  'js/app.js:renderSalvageBench|boltIco': '11px talent mark inline with a gear label in the melt row; the same site renderCharacter carried before v588.',
