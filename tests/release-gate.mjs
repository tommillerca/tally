...
const DECLARED = {
  ...
  'name-fit-audit.mjs': ['full', 'Self-served player-name census: rendered CONTROL, FITS, LEGIBLE and INTACT across names, viewports and text sizes. Missing surfaces exit 97.'],
