...
PURE.push('restore-debt-audit.mjs'); // P3: deliberately red until pet merge ordering, consumable revisions and future cooking preservation are implemented; Node-only.
