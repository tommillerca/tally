...
SLOTS = ['B', 'BG', 'C', 'CB', 'CE', 'CG', 'CM', 'E', 'FW', 'football', 'G', 'H',
         'IL', 'IR', 'M', 'P', 'S', 'SK', 'T', 'U']
# `morph/` TOO (Kennel palettes, 2026-09-05; art replaced with the v2 recolour,
# Tom approved 2026-09-06): assets/bh/C/morph/<species>__<morph>.png, built by
# scripts/build-pet-morphs-v2.py, same shape as the shiny/ subfolder it sits
