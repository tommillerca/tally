...
- **Talent specs (WoW-style, simplified)**: one point per level across three specs that change how you fight: Slab (lifesteal heavies + TITAN, a once-per-fight defense-ignoring slam), Greyhound (+1 AP, counter-jabs on dodged heavies, FLURRY wind-dump combo), Ringmaster (fast Hype, 25 starting Hype, cheaper harder Signatures). Linear 3-node chains, free respec, top ladder foes run specs too.
