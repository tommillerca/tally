...
| F17 | Logging | from `docs/BUGS-v580.md`: deleting a logged food has no confirm, no name in the message, no undo | Tom, 2026-09-12: "f17 i think just a confirm would be fine". **IMPLEMENTED, browser proof pending:** a shared confirm naming the food, no undo. Audit: `tests/log-delete-confirm-audit.mjs` (unrun in this lane) | `docs/BUGS-v580.md`, R5-B6 |
