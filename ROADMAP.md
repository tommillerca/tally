...
| F19 | Wardrobe | Tom, 2026-09-12: "there seems like no transmog anymore just two cluttered buttons now slots and dressing room this is sloppy work" | **OPEN — NEEDS TOM.** Transmog is not gone: it is the "Dressing Room" toggle, which was never labelled transmog to a player. Measured after tapping a slot, three stacked buttons: "Back to slots" (added by me in v579), "Dressing Room", "Take off". The clutter is mine; the naming is a product call | measured at 393x852 |
