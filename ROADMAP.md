...
| F22 | Server | Tom, 2026-09-12: "D5 podium settlement then fix the rest of the bugs" | **RULED, unbuilt.** Build order: podium settlement atomicity (#1), then replay identity (#2), flagged friends (#5), cheer retry key (#10). Built in lanes with the in-process Worker harness; deploy is Tom's | `docs/BUGS-v588-server.md` |
| F23 | Economy | Tom, 2026-09-12: "D4  more explanation needed" on `docs/BUGS-v588-economy.md` | **OPEN, DECISION.** Explanation sent 2026-09-12 | `docs/BUGS-v588-economy.md` |
