...
**Build order:** ✅ **Batch A SHIPPED v149** (R1 + R4). ✅ **R3+R8 SHIPPED v150** (Shop tab + Trends→Progress merge; also finishes R1's merchant-findability). ✅ **Batch B SHIPPED v151** (R2 patch-notes auto-popup). Next: Batch C pantry (R5), Batch D quests + consumables (R9 + R7). R6/R10 delivered.
