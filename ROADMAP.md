...
**Build order:** ✅ **Batch A SHIPPED v149** (R1 + R4). ✅ **R3+R8 SHIPPED v150** (Shop tab + Trends→Progress merge; also finishes R1's merchant-findability). Next: Batch B patch-notes auto-popup (R2), Batch C pantry (R5), Batch D quests + consumables (R9 + R7). R6/R10 delivered.
