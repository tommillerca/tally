...
| F6 | Names | Names still clipped at `#newcomersList .t3-tx b` (3758px of text in a 143px box) and `#lbBody .lb-who b` (86 in 77), plus 144 rows at 200%/53px text | **BUILT IN LANE, browser proof pending.** Re-measured 2026-09-12 on main with real builder-length names: the 3758px row was an impossible 128-W fixture; the real squeezes are `.pod-name` (154 in 83), `#lbBody .lb-who b` (261 in 162), the race header, gift sender, tower and Crew plates. Names now wrap at those sites and `name-fit-audit` is promoted to full | `tests/name-fit-audit.mjs`, `docs/CLAIMS.md` v588 |
