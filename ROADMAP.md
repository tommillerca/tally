...
| F21 | Steps | Tom, 2026-09-12, on the race week boundary (server finding #4): "D6 make it local" | **LIVE, both halves** (Worker 23e80a11, 2026-09-12). Local calendar Fridays on the phone; the Worker accepts a key within one day of its UTC period start | `docs/BUGS-v588-server.md` #4 |
| F22 | Server | Tom, 2026-09-12: "D5 podium settlement then fix the rest of the bugs" | **ALL LIVE.** Worker 23e80a11 deployed 2026-09-12 14:57 on Tom's "d1 deploy now". Build order: podium settlement atomicity (#1), then replay identity (#2), flagged friends (#5), cheer retry key (#10). Built in lanes with the in-process Worker harness; deploy is Tom's | `docs/BUGS-v588-server.md` |
| F23 | Economy | Tom, 2026-09-12: "D4  more explanation needed" on `docs/BUGS-v588-economy.md` | Tom, 2026-09-12: "d4 i think we need to do them all?" **ALL SIX LIVE**, client in v590 and Worker 23e80a11 (2026-09-12) | `docs/BUGS-v588-economy.md` |
