...
SWIFT_RESILIENT_CLASS("_TtC3App23BoneheadzViewController")
@interface BoneheadzViewController : CAPBridgeViewController
...
SWIFT_CLASS_NAMED("HealthPlugin")
@interface HealthPlugin : CAPPlugin <CAPBridgedPlugin>
...
- (void)isAvailable:(CAPPluginCall * _Nonnull)call;
- (void)requestAuth:(CAPPluginCall * _Nonnull)call;
- (void)queryToday:(CAPPluginCall * _Nonnull)call;
- (void)debugWrite:(CAPPluginCall * _Nonnull)call;
