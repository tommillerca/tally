...
// Usage from this checkout: node docs/leaderboard-honesty/run-pure.mjs
...
const out=mkdtempSync(join(tmpdir(),'leaderboard-honesty-pure-'));
...
writeFileSync(join(root,'docs/leaderboard-honesty/pure-results.json'),JSON.stringify(results,null,2)+'\n');
