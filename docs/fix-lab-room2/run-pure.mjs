...
// Usage from this checkout: node docs/fix-lab-room2/run-pure.mjs
...
const out=mkdtempSync(join(tmpdir(),'room2-pure-'));
...
writeFileSync(join(root,'docs/fix-lab-room2/pure-results.json'),JSON.stringify(results,null,2)+'\n');
