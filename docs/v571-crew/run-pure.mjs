...
// Usage from this checkout: node docs/v571-crew/run-pure.mjs
...
const out=mkdtempSync(join(tmpdir(),'v571-crew-pure-'));
...
writeFileSync(join(root,'docs/v571-crew/pure-results.json'),JSON.stringify(results,null,2)+'\n');
