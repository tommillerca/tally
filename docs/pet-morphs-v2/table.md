...
| region | source | ember | frost | toxic | midnight | px (dominant) |
|---|---|---|---|---|---|---|
| body | #cffbff | #fa7646 | #a6dbf5 | #b2f244 | #473980 | 9122 |
| drops | #62e6f2 | #ffb726 | #d9efff | #4d9917 | #8da6d9 | 600 |
| cream | #fff9dd | = (kept) | = (kept) | = (kept) | = (kept) | 1293 |
| white | #ffffe7 | = (kept) | = (kept) | = (kept) | = (kept) | 167 |
| blush | #ff918d | = (kept) | = (kept) | = (kept) | = (kept) | 301 |
| ink | #20201c | = | = | = | = | 7592 |
...
| region | source | ember | frost | toxic | midnight | px (dominant) |
|---|---|---|---|---|---|---|
| body | #9f6b2e | #b84c25 | #8dbcd9 | #99d92b | #3e3473 | 6416 |
| head | #2eb920 | #8c151f | #37629e | #13802e | #663f8c | 1158 |
| beak | #ff7536 | #ffba19 | #f5b093 | #ffec19 | #777ec7 | 400 |
| speculum | #4646bd | #ffbe26 | #e0f2ff | #eeff33 | #8da6d9 | 321 |
| cream | #fcf0d0 | = (kept) | = (kept) | = (kept) | = (kept) | 1240 |
| white | #ffffe7 | = (kept) | = (kept) | = (kept) | = (kept) | 270 |
| ink | #20201c | = | = | = | = | 6965 |
...
| region | source | ember | frost | toxic | midnight | px (dominant) |
|---|---|---|---|---|---|---|
| body | #a8a6ff | #fa9a7d | #aadffa | #c3f56e | #564a94 | 3923 |
| body | #6460fc | #eb4b23 | #60aee6 | #66ad15 | #2d1e6b | 3923 |
| rolls | #ff9692 | #ffc766 | #c7ceff | #fff373 | #8c679e | 774 |
| hilite | #affeff | #ffe9a6 | #ebf8ff | #f9ffb8 | #92ace0 | 429 |
| cream | #fff7d3 | = (kept) | = (kept) | = (kept) | = (kept) | 650 |
| white | #ffffe7 | = (kept) | = (kept) | = (kept) | = (kept) | 63 |
| ink | #20201c | = | = | = | = | 6771 |
...
| region | source | ember | frost | toxic | midnight | px (dominant) |
|---|---|---|---|---|---|---|
| body | #ff8245 | #eb4423 | #7ebee6 | #64b81c | #3a2d80 | 7638 |
| marks | #fcf428 | #ffb726 | #e0f5ff | #e2ff26 | #8da6d9 | 923 |
| belly | #fff9dd | #fff0d6 | #fcffed | #ffffdb | #f5f5e1 | 4904 |
| drool | #b6f0e8 | = (kept) | = (kept) | = (kept) | = (kept) | 132 |
| white | #ffffe7 | = (kept) | = (kept) | = (kept) | = (kept) | 704 |
| ink | #20201c | = | = | = | = | 9067 |
...
| region | source | ember | frost | toxic | midnight | px (dominant) |
|---|---|---|---|---|---|---|
| body | #ca906c | #cc5b39 | #8baec7 | #85b250 | #433973 | 9694 |
| stripes | #ff7b5b | #ffbb33 | #65ade0 | #e2f230 | #7a8fcc | 737 |
| cream | #fff2d4 | = (kept) | = (kept) | = (kept) | = (kept) | 1409 |
| white | #ffffe3 | = (kept) | = (kept) | = (kept) | = (kept) | 415 |
| ink | #20201c | = | = | = | = | 8814 |
...
| region | source | ember | frost | toxic | midnight | px (dominant) |
|---|---|---|---|---|---|---|
| stripes | #ffe100 | #ff6619 | #a6e1ff | #97f218 | #48379e | 127822 |
| cream | #fff1c7 | = (kept) | = (kept) | = (kept) | = (kept) | 561967 |
| blush | #ffb7a1 | = (kept) | = (kept) | = (kept) | = (kept) | 4249 |
| ink | #20201c | = | = | = | = | 614372 |
