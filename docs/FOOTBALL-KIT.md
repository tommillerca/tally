...
**section 8 is a patch to `js/app.js` that has NOT been applied**: the shop shelf
...
| The shop | `js/app.js` `footballShelfHtml` | the kit room, gated on `FOOTBALL_KIT_LIVE` at the call site. **Still renders per-team tiles: see section 8** |
...
## 8. app.js changes still to apply
